...
traindata = pd.read_csv('classical/data/training_data_combined_ihr_30_spo2_60.csv', header=None)
testdata = pd.read_csv('classical/data/test_data_combined_ihr_30_spo2_60.csv', header=None)
